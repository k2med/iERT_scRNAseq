# ---------------------------
# Title: Fig.5 — cDC UMAP, marker dotplot, heatmap, and GSVA violin plot
# Purpose:
...
# ---------------------------
# 2) UMAP colored by fine cDC cell types (Fig.5A.umap)
# ---------------------------
...
# ---------------------------
# 3) Dotplot of cDC marker genes (Fig.5A.dotplot)
# ---------------------------
...
# ---------------------------
# 5) Fig.5B — GSVA vlnplot of cDC subsets
# ---------------------------
