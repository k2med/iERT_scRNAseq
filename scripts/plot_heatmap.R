# Heatmap utility functions adapted from Luca et al. 2021 (DOI: 10.1016/j.cell.2021.09.014)
heatmap_simple <- function(mat, 
                           ...
                           legend_name = "",
                           col = NULL,
                           color_range = c(-2, 0, 2), color_palette = c("gray", "#762a83", "black", "yellow"),
                           name = "hmap",
                           ...)
{
  ...
  Heatmap(as.matrix(mat), top_annotation = top_annotation, left_annotation = left_annotation, 
          ...
          heatmap_legend_param = list(legend_direction = "vertical", color_bar = "continuous", #border = "black", 
...
top_markers_left <- function(data, top_n = 5, ord = NULL, ord_col = NULL, cex = NULL)
{
  markers = NULL
